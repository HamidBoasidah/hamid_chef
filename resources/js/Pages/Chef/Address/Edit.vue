<template>
  <ChefLayout>
    <PageBreadcrumb :pageTitle="t('chef_address.edit_address')" />
    <div class="space-y-5 sm:space-y-6">
      <ComponentCard :title="t('chef_address.edit_address')">
...
const form = useForm({
  ...
  governorate_id: address.value.governorate_id || '',
  district_id: address.value.district_id || '',
  area_id: address.value.area_id || '',
  address: address.value.address || '',
  street: address.value.street || '',
  building_number: address.value.building_number || '',
  floor_number: address.value.floor_number || '',
  apartment_number: address.value.apartment_number || '',
...
const submit = () => {
  form.put(route('chef.addresses.update', address.value.id))
}
</script>
