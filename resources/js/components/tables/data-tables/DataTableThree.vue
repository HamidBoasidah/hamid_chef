          ...
          <tr>
            ...
            <th class="px-4 py-3 text-start border border-gray-100 dark:border-gray-800">
              <div
                ...
                @click="sortBy('name')"
              >
                <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">{{ t('datatable.user') }}</p>
            ...
            <th class="px-4 py-3 text-start border border-gray-100 dark:border-gray-800">
              ...
              >
                <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">{{ t('datatable.position') }}</p>
                <span class="flex flex-col gap-0.5">
                  <svg
                    class="fill-gray-300 dark:fill-gray-700"
                    width="8"
            ...
            <th class="px-4 py-3 text-start border border-gray-100 dark:border-gray-800">
              <div
                ...
                @click="sortBy('salary')"
              >
                <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">{{ t('datatable.salary') }}</p>
                <span class="flex flex-col gap-0.5">
                  <svg
                    class="fill-gray-300 dark:fill-gray-700"
                    width="8"
            ...
            <th class="px-4 py-3 text-start border border-gray-100 dark:border-gray-800">
              <div
                ...
                @click="sortBy('office')"
              >
                <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">{{ t('datatable.office') }}</p>
                <span class="flex flex-col gap-0.5">
                  <svg
                    class="fill-gray-300 dark:fill-gray-700"
                    width="8"
            ...
            <th class="px-4 py-3 text-start border border-gray-100 dark:border-gray-800">
              <div
                ...
                @click="sortBy('active')"
              >
                <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">{{ t('datatable.status') }}</p>
                <span class="flex flex-col gap-0.5">
                  <svg
                    class="fill-gray-300 dark:fill-gray-700"
                    width="8"
            ...
            <th class="px-4 py-3 text-start border border-gray-100 dark:border-gray-800">
              <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">{{ t('datatable.toggle') }}</p>
            </th>
            <th class="px-4 py-3 text-start border border-gray-100 dark:border-gray-800">
              <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">{{ t('datatable.action') }}</p>
            </th>
          </tr>
        </thead>
        <tbody>
          ...
          >
            ...
            <td class="px-4 py-3 border border-gray-100 dark:border-gray-800">
              <div class="flex items-center gap-3">
                <div class="h-10 w-10">
                  <img :src="person.image || '/images/user/owner.jpg'" class="h-10 w-10 rounded-full object-cover" alt="" />
                </div>
                <div class="flex flex-col">
                  <span class="text-sm font-medium text-gray-700 dark:text-gray-400">{{ person.name }}</span>
                  <span class="text-xs text-gray-500 dark:text-gray-400">{{ person.email }}</span>
                </div>
              </div>
            </td>
            <td class="px-4 py-3 border border-gray-100 dark:border-gray-800">
            ...
            <td class="px-4 py-3 border border-gray-100 dark:border-gray-800">
              <span
                ...
                :class="{
                  'bg-green-50 text-green-600 dark:bg-green-500/15 dark:text-green-500': person.active,
                  'bg-error-50 text-error-600 dark:bg-error-500/15 dark:text-error-500': !person.active,
                }"
              >
                {{ person.active ? t('datatable.active') : t('datatable.inactive') }}
              </span>
            </td>
            <td class="px-4 py-3 border border-gray-100 dark:border-gray-800">
              <label :for="'toggle-' + person.id" class="cursor-pointer">
                <div class="relative">
                  <input
                    type="checkbox"
                    :id="'toggle-' + person.id"
                  ...
                  <div
                    ...
                    :class="person.active ? 'bg-brand-500 dark:bg-brand-500' : 'bg-gray-200 dark:bg-white/10'"
                  ></div>
                  <div
                    :class="[person.active ? 'rtl:translate-x-[-100%] ltr:translate-x-full' : 'translate-x-0']"
...
const toggleSelectAll = () => {
  data.value.forEach((person) => (person.selected = selectAll.value))
}

const updateSelectAll = () => {
  selectAll.value = data.value.every((person) => person.selected)
}
</script>
