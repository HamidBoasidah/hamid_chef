      ...
      <div class="p-4 sm:p-6">
        <div class="grid grid-cols-1 gap-x-5 gap-y-6 md:grid-cols-2">
          ...
          <div>
            ...
            <p class="text-base text-gray-800 dark:text-white/90">{{ address.street ?? '—' }}</p>
          </div>
          ...
          <div>
            ...
            <p class="text-base text-gray-800 dark:text-white/90">{{ address.building_number ?? '—' }}</p>
          </div>
          ...
          <div>
            ...
            <p class="text-base text-gray-800 dark:text-white/90">{{ address.floor_number ?? '—' }}</p>
          </div>
          ...
          <div>
            ...
            <p class="text-base text-gray-800 dark:text-white/90">{{ address.apartment_number ?? '—' }}</p>
          </div>
