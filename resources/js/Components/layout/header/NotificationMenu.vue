  ...
  <div class="relative" ref="dropdownRef">
    ...
    >
      <span
        ...
        class="absolute top-0.5 z-1 h-2 w-2 rounded-full bg-orange-400 ltr:right-0 rtl:left-0"
      >
        <span
    ...
    <div
      v-if="dropdownOpen"
      class="absolute mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[361px]
             ltr:-right-[240px] rtl:-left-[240px] lg:ltr:right-0 lg:rtl:left-0"
    >
      <div
        class="flex items-center justify-between pb-3 mb-3 border-b border-gray-100 dark:border-gray-800"
      >
        <h5 class="text-lg font-semibold text-gray-800 dark:text-white/90">{{ t('pages.notificationTitle') }}</h5>
          ...
          >
            <span class="relative block w-full h-10 rounded-full z-1 max-w-10">
              ...
              <span
                ...
                class="absolute bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900 ltr:right-0 rtl:left-0"
              ></span>
            </span>
            ...
            <span class="block">
              <span class="mb-1.5 block text-theme-sm text-gray-500 dark:text-gray-400">
                ...
                <span class="font-medium text-gray-800 dark:text-white/90">
                  {{ t('notifications.project', { name: notification.projectName }) }}
                </span>
              </span>

              <span class="flex items-center gap-2 text-gray-500 text-theme-xs dark:text-gray-400">
                <span>{{ t(notification.typeKey) }}</span>
...
const notifications = ref([
  {
    ...
    actionKey: 'notifications.requestsPermission',
    projectName: 'Nganter App',
    typeKey: 'notifications.typeProject',
    time: '5 min ago',
    status: 'online',
  },
  {
