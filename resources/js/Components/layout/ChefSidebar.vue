              ...
              <li>
                <Link
                  ...
                  :class="[
                    'menu-item group',
                    {
                      'menu-item-active': isActive(route('chef.index')),
                      'menu-item-inactive': !isActive(route('chef.index')),
                    },
                  ]"
                >
                  <span :class="[isActive(route('chef.index')) ? 'menu-item-icon-active' : 'menu-item-icon-inactive']">
                    <UserCircleIcon />
                  </span>
...
import { UserCircleIcon, CalenderIcon, TaskIcon, HorizontalDots } from '../../icons'
